...
subtest 'string value' => sub {
    ...
    like( $d->dump($hash), qr/^My::Object::Hash=HASH\(0x[[:xdigit:]]+\)$/ );
    like( $d->dump($array), qr/^My::Object::Array=ARRAY\(0x[[:xdigit:]]+\)$/ );
    like( $d->dump($scalar), qr/^My::Object::Scalar=SCALAR\(0x[[:xdigit:]]+\)$/ );
};
